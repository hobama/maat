...
namespace test{
    namespace expression{
        ...
        unsigned int concretization(){
            ...
            // as unsigned
            nb += _assert( exprcst(7, 0xfffff)->as_unsigned() == 0x7f, "Interpretation as unsigned failed");
            nb += _assert( exprcst(64, 0xffff0000ffff0000)->as_unsigned() == 0xffff0000ffff0000, "Interpretation as unsigned failed");
            nb += _assert( exprcst(16, 0xffff0000)->as_unsigned() == 0, "Interpretation as unsigned failed");
